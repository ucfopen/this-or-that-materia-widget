...
A quiz tool where students must answer questions by selecting one of two choices, which may be images, text, audio, or embedded video. For each question, instructors provide the question text, correct selection and description, incorrect selection and description, and optional feedback if the incorrect image is selected.
...
![This or That Player](src/_screen-shots/1.png)
