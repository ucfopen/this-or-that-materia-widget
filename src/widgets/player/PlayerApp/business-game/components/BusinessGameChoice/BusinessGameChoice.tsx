...
import ImageLightboxContents from '../../../components/ImageLightboxContents/ImageLightboxContents'
...
export default function BusinessGameChoice({
  choiceType, mediaUrl, mediaAltText, answerText, answerFeedback, onSelect, state, highlightCorrectOnFail, disabled, animationState, openLightbox,
  ...
  if (choiceType === 'image') {
    ...
    mediaRender = (
      <BusinessChoiceContent
        ...
        disabled={disabled}
        onHover={setHovered}>
        <img className={styles.imgChoice} src={mediaUrl} alt={mediaAltText} />
      </BusinessChoiceContent>
    )
    lightboxContent = (
      <ImageLightboxContents src={mediaUrl} alt={mediaAltText} />
    )
